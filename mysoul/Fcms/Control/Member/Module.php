...
class Module extends \Soulcms\Table
{
    ...
    protected function _Call_Post($data) {
        ...
        if ($data[1]['status'] == 9) {
            ...
            \Soulcms\Service::L('input')->post('is_draft') ? $this->_json(1, mys_lang('操作成功，已存储到草稿箱')) : $this->_json(1, mys_lang('The operation succeeds. Wait for the administrator approval'), ['id' => $data[1]['id'], 'catid' => $data[1]['catid']]);
        }
    }
}
