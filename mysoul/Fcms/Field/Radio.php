...
class Radio extends \Soulcms\Library\A_Field {
				...
				<div class="col-md-9">
					<div class="mt-radio-inline">
						<label class="mt-radio  mt-radio-outline">
							<input type="radio" name="data[setting][option][show_type]" value="0" '.(!$option['show_type'] ? 'checked' : '').'> '.mys_lang('横排显示').'
							<span></span>
						</label>
						<label class="mt-radio  mt-radio-outline">
							<input type="radio" name="data[setting][option][show_type]" value="1" '.($option['show_type'] ? 'checked' : '').'> '.mys_lang('竖排显示').'
							<span></span>
						</label>
					</div>
    ...
    public function show($field, $value = null) {
        ...
        $str = '<div class="form-control-static"> '.(isset($options[$value]) ? $options[$value] : mys_lang('未选择')).' </div>';
