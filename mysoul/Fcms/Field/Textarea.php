 ...
 *
 * */
class Textarea extends \Soulcms\Library\A_Field {
    ...
    public function show($field, $value = null) {
        ...
        <div class="scroller" style="width:'.(\Soulcms\Service::_is_mobile() ? '100%' : ($field['setting']['option']['width'] ? ($field['setting']['option']['width'].(is_numeric($field['setting']['option']['width']) ? 'px' : '')) : '400px')).';height:'.($field['setting']['option']['height'] ? $field['setting']['option']['height'] : '100').'px" data-always-visible="1" data-rail-visible="1">
	...
	public function input($field, $value = '') {
		...
		$str = '<textarea class="form-control" style="height:'.$height.'px; width:'.$width.(is_numeric($width) ? 'px' : '').';" name="data['.$name.']" id="mys_'.$name.'" '.$attr.'>'.$value.'</textarea>';
