 ...
 */
$routes->setDefaultNamespace('Soulcms\Controllers');
...
if (IS_ADMIN) {
    $routes->setDefaultNamespace('Soulcms\Controllers\Admin');
} elseif (IS_MEMBER) {
    $routes->setDefaultNamespace('Soulcms\Controllers\Member');
} elseif (IS_API) {
    $routes->setDefaultNamespace('Soulcms\Controllers\Api');
}
...
require CMSPATH.'Core/Soulcms.php';
