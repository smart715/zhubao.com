...
class Uploader
{
    ...
    public function __construct($fileField, $config, $type = "upload")
    {
        ...
        $this->attachment_model = \Soulcms\Service::M('Attachment');
        $rt = $this->attachment_model->check(\Soulcms\Service::C()->member, SITE_ID);
        if (!$rt['code']) {
            // 错误提示
        ...
        $this->watermark = \Soulcms\Service::C()->get_cache('site', SITE_ID, 'watermark', 'ueditor') ? 1 : intval($_GET['is_wm']);
